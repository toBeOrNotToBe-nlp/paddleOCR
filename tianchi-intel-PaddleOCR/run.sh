...
python3 tools/infer/predict_system.py --image_dir="./1.jpg" --det_model_dir="./pretrain_models/det_r50_vd_sast_icdar15_v2.0_train/"  --rec_model_dir="./inference/ch_ppocr_server_v2.0_rec_infer/" --cls_model_dir='./inference/ch_ppocr_mobile_v2.0_cls_infer/' --use_angle_cls=True --use_space_char=True

python tools/train.py -c configs/det/det_r50_vd_sast_icdar15.yml -o Global.pretrain_weights=./pretrain_models/det_r50_vd_sast_icdar15_v2.0_train/
python tools/export_model.py -c configs/det/det_r50_vd_sast_icdar15.yml -o Global.pretrained_model=output/sast_r50_vd_ic15/latest  Global.save_inference_dir=output/sast_r50_vd_ic15/
python tools/infer/predict_system_tianchi.py --det_model_dir="output/sast_r50_vd_ic15/"  --rec_model_dir="./inference/ch_ppocr_server_v2.0_rec_infer/" --cls_model_dir="./inference/ch_ppocr_mobile_v2.0_cls_infer/" --use_angle_cls=True --use_space_char=True

python tools/infer/predict_system.py --image_dir="./1.jpg" --det_model_dir="output/sast_r50_vd_ic15/"  --rec_model_dir="./inference/ch_ppocr_server_v2.0_rec_infer/" --cls_model_dir="./inference/ch_ppocr_mobile_v2.0_cls_infer/" --use_angle_cls=True --use_space_char=True
